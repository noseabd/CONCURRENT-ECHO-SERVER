...
public class clientFrame extends javax.swing.JFrame implements Runnable{
    ...
    public clientFrame(int cln_no) throws IOException{
        ...
        //jTextField1.addActionListener(this);
         clln_no=cln_no;
         System.out.println("pulak server :" + clln_no);
         this.setTitle("CLIENT:"+clln_no);
        t = new Thread(this);
t.start();     
    }
 public void run() {
...
while (true) {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(Itterative_Echo.EchoserverupApp.class).getContext().getResourceMap(clientFrame.class);
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
       ...
       System.out.println("pulak "+evt.getID()) ;
       event=evt.getID();

...
while (true) {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(echoserverup.EchoserverupApp.class).getContext().getResourceMap(clientFrame.class);
